...
or L<qx()|perlop/"qx"> function (albeit one that always returns
a scalar). 
...
# segfaults during cleanup haven't been observed in a long time ...
# let's retire this section unless they come back ...

_head2 Segfaults during cleanup
