...
=head1 SYNOPSIS
    ...
    $pid = Forks::Super::fork( \%options );  # see Forks
    $job = Forks::Super::Job::_get($pid);
...
Use the C<Forks::Super::Job::_get> method to obtain a Forks::Super::Job object for
examination. The C<Forks::Super::Job::_get> method takes a process ID or
